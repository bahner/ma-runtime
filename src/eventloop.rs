...
impl EventLoopState {
    fn new(args: RunArgs) -> Self {
        Self {
            ...
            rpc_messages: args.rpc_messages,
            inbox_messages: args.inbox_messages,
            crud_messages: args.crud_messages,
            ipfs_state: args.ipfs_state,
            envelope_tx: args.envelope_tx,
            envelope_rx: args.envelope_rx,
            shared_config: args.shared_config,
            shared_resolver: args.shared_resolver,
            stats: args.stats,
            acl: args.acl,
            acl_cache: args.acl_cache,
            group_cache: args.group_cache,
            entity_registry: args.entity_registry,
            kind_registry: args.kind_registry,
            manifest_writer: args.manifest_writer,
            our_did: args.our_did,
            signing_key: args.signing_key,
            runtime_ipns_key: args.runtime_ipns_key,
            runtime_slug: args.runtime_slug,
            remote_pin: args.remote_pin,
            did_publish_timeout_secs: args.did_publish_timeout_secs,
            ipns_publish: args.ipns_publish,
            did_resolve: args.did_resolve,
