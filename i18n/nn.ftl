...
bootstrap-kind-registry-fetch-failed = Klarte ikkje hente kind-node for registeret
...
outbox-connect-backoff = Utboks-tilkopling mislukkast; brukar Fibonacci-backoff
outbox-connect-failed-fallback = Bufra utboks-tilkopling mislukkast; fell tilbake til resolver
outbox-connect-timed-out-fallback = Bufra utboks-tilkopling tidsavbrot; fell tilbake til resolver
outbox-connect-timeout-backoff = Utboks-tilkopling tidsavbrot; brukar Fibonacci-backoff
plugin-dispatch-rejected = Plugin-utsending avvist
