...
boot-default-root-config-skip = Standard konfigurasjonsrot er alt sett
boot-entity-load-processed = Einingsplugin lasta
boot-runtime-kinds-overlay-failed = Klarte ikkje å leggje på kind-CID-overlagringa
boot-runtime-manifest-load-failed = Klarte ikkje å laste manifestet for å fylle ACL-hurtigbufferet
boot-runtime-root-cid-resolve-failed = Klarte ikkje å løyse runtime-root-CID frå IPNS
inbox-empty-payload-dropped = innboks: tom nyttelast forkasta
inbox-unfragmented-dropped = innboks: ufragmentert melding forkasta
inbox-unknown-entity = innboks: ukjent einingsfragment; forkasta
inbox-dispatching = innboks: sender til eining
inbox-behaviour-ignored = innboks: førespurnader om ma_set_behaviour blir ignorerte ved innboksdistribusjon utan svar
...
plugin-envelope-local-reply-dropped = plugin-konvolutt: lokalt RPC-svar forkasta (ingen lokal svarmottakar)
