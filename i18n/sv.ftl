...
default-config-root-populated = Standardvärde för /config/root sattes vid start
default-config-root-no-root-entity = Kan inte sätta standardvärde för /config/root vid start: #root-enheten är inte laddad
default-config-root-no-root-cid = Kan inte sätta standardvärde för /config/root vid start: ingen manifest-root-CID är tillgänglig
default-config-root-inspect-failed = Kunde inte läsa manifestet före standardvärde för /config/root sattes
default-config-root-populate-failed = Kunde inte sätta standardvärde för /config/root vid start
...
owners-value-not-list = owners-värdet måste vara en lista med DID:er, inte ett enskilt värde
...
boot-default-root-config-skip = Standardkonfigurationsroten är redan inställd
...
boot-runtime-kinds-overlay-failed = Kunde inte tillämpa kinds-CID-overlay
boot-runtime-manifest-load-failed = Kunde inte ladda manifest för ACL-cachefyllning
boot-runtime-root-cid-resolve-failed = Kunde inte lösa runtime-rot-CID från IPNS
...
bootstrap-kind-registry-fetch-failed = Kunde inte hämta kinds-nod för registret
...
inbox-behaviour-ignored = Inkorg: ma_set_behaviour-förfrågningar ignoreras vid fire-and-forget-dispatch
inbox-dispatching = Inkorg: dispatchar till entitet
inbox-empty-payload-dropped = Inkorg: tomt nyttolast kasserat
inbox-message-rejected = Inkorgsmeddelande avvisat
inbox-unfragmented-dropped = Inkorg: ofragmenterat meddelande kasserat
inbox-unknown-entity = Inkorg: okänt entitetsfragment; kasserat
...
outbox-connect-backoff = Utbox-anslutning misslyckades; tillämpar Fibonacci-backoff
outbox-connect-failed-fallback = Cachad utbox-anslutning misslyckades; faller tillbaka till resolver
outbox-connect-timed-out-fallback = Cachad utbox-anslutning tidde ut; faller tillbaka till resolver
outbox-connect-timeout-backoff = Utbox-anslutning tidde ut; tillämpar Fibonacci-backoff
plugin-dispatch-rejected = Plugin-dispatch avvisad
...
plugin-envelope-local-reply-dropped = Plugin-kuvert: lokalt RPC-svar kasserat (ingen lokal svarsavvaktare)
