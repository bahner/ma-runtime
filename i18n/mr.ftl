...
boot-default-root-config-skip = डिफॉल्ट रूट कॉन्फिगरेशन आधीच सेट आहे
...
boot-runtime-kinds-overlay-failed = Kinds CID ओव्हरले लागू करण्यात अयशस्वी
boot-runtime-manifest-load-failed = ACL कॅश भरण्यासाठी मॅनिफेस्ट लोड करण्यात अयशस्वी
boot-runtime-root-cid-resolve-failed = IPNS मधून रनटाइम रूट CID रिझोल्व्ह करण्यात अयशस्वी
...
bootstrap-kind-registry-fetch-failed = रेजिस्ट्रीसाठी Kind नोड आणण्यात अयशस्वी
...
inbox-behaviour-ignored = इनबॉक्स: fire-and-forget पाठवण्यावर ma_set_behaviour विनंत्या दुर्लक्षित केल्या जातात
inbox-dispatching = इनबॉक्स: एंटिटीला पाठवत आहे
inbox-empty-payload-dropped = इनबॉक्स: रिकामा पेलोड सोडला
inbox-message-rejected = इनबॉक्स संदेश नाकारला
inbox-unfragmented-dropped = इनबॉक्स: अखंडित संदेश सोडला
inbox-unknown-entity = इनबॉक्स: अज्ञात एंटिटी फ्रॅगमेंट; सोडला
...
outbox-connect-backoff = आउटबॉक्स कनेक्शन अयशस्वी; Fibonacci बॅकऑफ लागू होत आहे
outbox-connect-failed-fallback = कॅशमधून आउटबॉक्स कनेक्शन अयशस्वी; रिझोल्व्हरकडे परत जात आहे
outbox-connect-timed-out-fallback = कॅशमधून आउटबॉक्स कनेक्शन टाइमआउट झाले; रिझोल्व्हरकडे परत जात आहे
outbox-connect-timeout-backoff = आउटबॉक्स कनेक्शन टाइमआउट झाले; Fibonacci बॅकऑफ लागू होत आहे
plugin-dispatch-rejected = प्लगिन डिस्पॅच नाकारले
...
plugin-envelope-local-reply-dropped = प्लगिन एनव्हलप: स्थानिक RPC उत्तर सोडले (स्थानिक उत्तर प्रतीक्षक नाही)
