...
boot-default-root-config-skip = Vaikimisi juureseadistus on juba seadistatud
...
boot-runtime-kinds-overlay-failed = Kinds CID katmise rakendamine ebaõnnestus
boot-runtime-manifest-load-failed = Manifesti laadimine ACL vahemälu täitmiseks ebaõnnestus
boot-runtime-root-cid-resolve-failed = Käituskeskkonna juure CID lahendamine IPNS-st ebaõnnestus
...
bootstrap-kind-registry-fetch-failed = Kind-sõlme toomine registri jaoks ebaõnnestus
...
inbox-behaviour-ignored = Postkast: ma_set_behaviour päringuid eiratakse fire-and-forget saatmisel
inbox-dispatching = Postkast: saatmine olemile
inbox-empty-payload-dropped = Postkast: tühi kasulik koormus kõrvaldatud
inbox-message-rejected = Postkasti sõnum lükati tagasi
inbox-unfragmented-dropped = Postkast: fragmenteerimata sõnum kõrvaldatud
inbox-unknown-entity = Postkast: tundmatu olemi fragment; kõrvaldatud
...
outbox-connect-backoff = Väljamineva postkasti ühendus ebaõnnestus; rakendatakse Fibonacci tagasiastumine
outbox-connect-failed-fallback = Väljamineva postkasti ühendus vahemälust ebaõnnestus; minnakse üle lahendajale
outbox-connect-timed-out-fallback = Väljamineva postkasti ühendus vahemälust aegus; minnakse üle lahendajale
outbox-connect-timeout-backoff = Väljamineva postkasti ühendus aegus; rakendatakse Fibonacci tagasiastumine
plugin-dispatch-rejected = Plugina saatmine lükati tagasi
...
plugin-envelope-local-reply-dropped = Plugina ümbrik: kohalik RPC vastus kõrvaldatud (pole kohalikku vastuse ootajat)
