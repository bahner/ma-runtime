...
default-config-root-populated = Standardwert für /config/root beim Start gesetzt
default-config-root-no-root-entity = Standardwert für /config/root kann beim Start nicht gesetzt werden: #root-Entität ist nicht geladen
default-config-root-no-root-cid = Standardwert für /config/root kann beim Start nicht gesetzt werden: keine Manifest-Root-CID verfügbar
default-config-root-inspect-failed = Manifest konnte vor dem Setzen des Standardwerts für /config/root nicht geprüft werden
default-config-root-populate-failed = Standardwert für /config/root konnte beim Start nicht gesetzt werden
...
owners-value-not-list = der owners-Wert muss eine Liste von DIDs sein, kein einzelner Wert
...
boot-default-root-config-skip = Standardkonfigurationswurzel bereits gesetzt
...
boot-runtime-kinds-overlay-failed = Kinds-CID-Overlay konnte nicht angewendet werden
boot-runtime-manifest-load-failed = Manifest für ACL-Cache-Befüllung konnte nicht geladen werden
boot-runtime-root-cid-resolve-failed = Runtime-Root-CID konnte nicht aus IPNS aufgelöst werden
...
bootstrap-kind-registry-fetch-failed = Kind-Knoten für Registry konnte nicht abgerufen werden
...
inbox-behaviour-ignored = Inbox: ma_set_behaviour-Anfragen werden bei Fire-and-Forget-Dispatch ignoriert
inbox-dispatching = Inbox: Weiterleitung an Entity
inbox-empty-payload-dropped = Inbox: leere Nutzlast verworfen
inbox-message-rejected = Inbox-Nachricht abgelehnt
inbox-unfragmented-dropped = Inbox: nicht fragmentierte Nachricht verworfen
inbox-unknown-entity = Inbox: unbekanntes Entity-Fragment; verworfen
...
outbox-connect-backoff = Outbox-Verbindung fehlgeschlagen; Fibonacci-Backoff wird angewendet
outbox-connect-failed-fallback = Gecachte Outbox-Verbindung fehlgeschlagen; Fallback auf Resolver
outbox-connect-timed-out-fallback = Gecachte Outbox-Verbindung abgelaufen; Fallback auf Resolver
outbox-connect-timeout-backoff = Outbox-Verbindung abgelaufen; Fibonacci-Backoff wird angewendet
plugin-dispatch-rejected = Plugin-Dispatch abgelehnt
...
plugin-envelope-local-reply-dropped = Plugin-Envelope: lokale RPC-Antwort verworfen (kein lokaler Antwortwarter)
