...
default-config-root-populated = स्टार्टअप पर डिफ़ॉल्ट /config/root भर दिया गया
default-config-root-no-root-entity = स्टार्टअप पर डिफ़ॉल्ट /config/root नहीं भरा जा सकता: #root entity लोड नहीं है
default-config-root-no-root-cid = स्टार्टअप पर डिफ़ॉल्ट /config/root नहीं भरा जा सकता: manifest root CID उपलब्ध नहीं है
default-config-root-inspect-failed = डिफ़ॉल्ट /config/root भरने से पहले manifest की जाँच विफल रही
default-config-root-populate-failed = स्टार्टअप पर डिफ़ॉल्ट /config/root भरना विफल रहा
...
boot-default-root-config-skip = डिफ़ॉल्ट रूट कॉन्फ़िगरेशन पहले से सेट है
...
boot-runtime-kinds-overlay-failed = Kinds CID ओवरले लागू करना विफल रहा
boot-runtime-manifest-load-failed = ACL कैश भरने के लिए मैनिफेस्ट लोड करना विफल रहा
boot-runtime-root-cid-resolve-failed = IPNS से रनटाइम रूट CID हल करना विफल रहा
...
bootstrap-kind-registry-fetch-failed = रजिस्ट्री के लिए Kind नोड प्राप्त करना विफल रहा
...
inbox-behaviour-ignored = इनबॉक्स: fire-and-forget भेजने पर ma_set_behaviour अनुरोध अनदेखे किए जाते हैं
inbox-dispatching = इनबॉक्स: एंटिटी को भेजा जा रहा है
inbox-empty-payload-dropped = इनबॉक्स: खाली पेलोड हटाया गया
inbox-message-rejected = इनबॉक्स संदेश अस्वीकृत
inbox-unfragmented-dropped = इनबॉक्स: अखंडित संदेश हटाया गया
inbox-unknown-entity = इनबॉक्स: अज्ञात एंटिटी फ्रैगमेंट; हटाया गया
...
outbox-connect-backoff = आउटबॉक्स कनेक्शन विफल रहा; Fibonacci बैकऑफ़ लागू हो रहा है
outbox-connect-failed-fallback = कैश से आउटबॉक्स कनेक्शन विफल रहा; रिज़ॉल्वर पर वापस जा रहे हैं
outbox-connect-timed-out-fallback = कैश से आउटबॉक्स कनेक्शन का समय समाप्त हुआ; रिज़ॉल्वर पर वापस जा रहे हैं
outbox-connect-timeout-backoff = आउटबॉक्स कनेक्शन का समय समाप्त हुआ; Fibonacci बैकऑफ़ लागू हो रहा है
plugin-dispatch-rejected = प्लगइन डिस्पैच अस्वीकृत
...
plugin-envelope-local-reply-dropped = प्लगइन एनवेलप: स्थानीय RPC उत्तर हटाया गया (कोई स्थानीय उत्तर प्रतीक्षक नहीं)
