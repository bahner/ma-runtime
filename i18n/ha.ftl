...
default-config-root-populated = An cika tsohon /config/root a lokacin farawa
default-config-root-no-root-entity = Ba za a iya cika tsohon /config/root a lokacin farawa ba: ba a loda entity #root ba
default-config-root-no-root-cid = Ba za a iya cika tsohon /config/root a lokacin farawa ba: babu root CID na manifest
default-config-root-inspect-failed = An kasa duba manifest kafin cika tsohon /config/root
default-config-root-populate-failed = An kasa cika tsohon /config/root a lokacin farawa
...
boot-default-root-config-skip = Tushen config na tsoho an riga an saita shi
...
boot-runtime-kinds-overlay-failed = An kasa aiwatar da kinds CID overlay
boot-runtime-manifest-load-failed = An kasa loda manifest don yada cache ACL
boot-runtime-root-cid-resolve-failed = An kasa warware runtime root CID daga IPNS
...
bootstrap-kind-registry-fetch-failed = An kasa dawo da node na kind don registry
...
inbox-behaviour-ignored = Inbox: an yi watsi da buƙatun ma_set_behaviour a isar da inbox fire-and-forget
inbox-dispatching = Inbox: ana isar zuwa entity
inbox-empty-payload-dropped = Inbox: an jefar da payload faro
inbox-message-rejected = An ƙi sakon inbox
inbox-unfragmented-dropped = Inbox: an jefar da sakon da ba a raba shi ba
inbox-unknown-entity = Inbox: guntu na entity da ba a sani ba; an jefar
...
outbox-connect-backoff = Haɗin outbox ya gaza; ana amfani da Fibonacci backoff
outbox-connect-failed-fallback = Haɗin outbox na cache ya gaza; ana dawo da resolver
outbox-connect-timed-out-fallback = Haɗin outbox na cache ya ƙare; ana dawo da resolver
outbox-connect-timeout-backoff = Haɗin outbox ya ƙare; ana amfani da Fibonacci backoff
plugin-dispatch-rejected = An ƙi isar da plugin
...
plugin-envelope-local-reply-dropped = Envelope na plugin: an jefar da amsar RPC ta gida (babu masu jiran amsa ta gida)
