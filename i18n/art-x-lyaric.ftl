...
default-config-root-populated = Default /config/root set pon startup
default-config-root-no-root-entity = Cyan set default /config/root pon startup: #root entity nah load
default-config-root-no-root-cid = Cyan set default /config/root pon startup: manifest root CID nah deh
default-config-root-inspect-failed = Manifest sight-up fail before default /config/root set
default-config-root-populate-failed = Default /config/root set pon startup fail
...
boot-runtime-kinds-overlay-failed = Faild fi apply kinds CID overlay
boot-runtime-manifest-load-failed = Faild fi load manifest fi ACL cache population
boot-runtime-root-cid-resolve-failed = Faild fi resolve runtime root CID from IPNS
...
bootstrap-kind-registry-fetch-failed = Faild fi fetch kind node fi registry
...
inbox-behaviour-ignored = Inbox: ma_set_behaviour requests are ignored pon fire-and-forget inbox dispatch
...
outbox-connect-backoff = Outbox connect faild; applying Fibonacci backoff
outbox-connect-failed-fallback = Cached outbox connect faild; falling back to resolver
