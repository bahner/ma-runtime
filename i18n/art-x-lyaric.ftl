...
boot-default-root-config-skip = Default config root set up already
...
inbox-dispatching = Inbox: a dispatch to entity
...
inbox-unknown-entity = Inbox: entity fragment nuh known; drop
...
outbox-connect-timed-out-fallback = Cached outbox connect time out; a fall back to resolver
outbox-connect-timeout-backoff = Outbox connect time out; a apply Fibonacci backoff
plugin-dispatch-rejected = Plugin dispatch reject by Zion
