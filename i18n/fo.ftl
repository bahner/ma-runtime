...
default-config-root-populated = Sjálvsett /config/root útfylt við uppstart
default-config-root-no-root-entity = Kann ikki útfylla sjálvsett /config/root við uppstart: #root-eindin er ikki lødd
default-config-root-no-root-cid = Kann ikki útfylla sjálvsett /config/root við uppstart: eingin manifest-root-CID er tøk
default-config-root-inspect-failed = Miseydnaðist at kanna manifestið áðrenn sjálvsett /config/root varð útfylt
default-config-root-populate-failed = Miseydnaðist at útfylla sjálvsett /config/root við uppstart
...
boot-default-root-config-skip = Vanlig rótarkonfiguration er longu sett
...
boot-runtime-kinds-overlay-failed = Brúking av kinds CID-yvurlag miseydnaðist
boot-runtime-manifest-load-failed = Hleðsla av manifest til at fylla ACL-skyndiminni miseydnaðist
boot-runtime-root-cid-resolve-failed = Uppgerð av rót-CID umhvørvis úr IPNS miseydnaðist
...
bootstrap-kind-registry-fetch-failed = Heinting av kinds-hnút fyri skrásetingar miseydnaðist
...
inbox-behaviour-ignored = Innkomandi: ma_set_behaviour-beiðnir eru hundsaðar við fire-and-forget sendingar
inbox-dispatching = Innkomandi: sendir til einingu
inbox-empty-payload-dropped = Innkomandi: tómt farmlag kastað
inbox-message-rejected = Boð úr innkomandi avvist
inbox-unfragmented-dropped = Innkomandi: óstykkta boð kastað
inbox-unknown-entity = Innkomandi: ókennd brot av einingu; kastað
...
outbox-connect-backoff = Sambond til útgangspósthús miseydnaðist; Fibonacci-atburður brúktur
outbox-connect-failed-fallback = Sambond til útgangspósthús úr skyndiminni miseydnaðist; fer til leysara
outbox-connect-timed-out-fallback = Sambond til útgangspósthús úr skyndiminni tók ov langan tíð; fer til leysara
outbox-connect-timeout-backoff = Sambond til útgangspósthús tók ov langan tíð; Fibonacci-atburður brúktur
plugin-dispatch-rejected = Sending frá viðgerð avvist
...
plugin-envelope-local-reply-dropped = Umslag frá viðgerð: staðbundið RPC-svar kastað (eingin staðbundin svarbiðlari)
