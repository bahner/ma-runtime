...
default-config-root-populated = Đã điền /config/root mặc định khi khởi động
default-config-root-no-root-entity = Không thể điền /config/root mặc định khi khởi động: thực thể #root chưa được tải
default-config-root-no-root-cid = Không thể điền /config/root mặc định khi khởi động: không có CID gốc của manifest
default-config-root-inspect-failed = Không thể kiểm tra manifest trước khi điền /config/root mặc định
default-config-root-populate-failed = Không thể điền /config/root mặc định khi khởi động
...
boot-default-root-config-skip = Cấu hình root mặc định đã được thiết lập
...
boot-runtime-kinds-overlay-failed = Không thể áp dụng Kinds CID overlay
boot-runtime-manifest-load-failed = Không thể tải manifest để điền ACL cache
boot-runtime-root-cid-resolve-failed = Không thể giải quyết runtime root CID từ IPNS
...
bootstrap-kind-registry-fetch-failed = Không thể lấy Kind node cho registry
...
inbox-behaviour-ignored = Inbox: các yêu cầu ma_set_behaviour bị bỏ qua khi gửi fire-and-forget
inbox-dispatching = Inbox: đang gửi đến entity
inbox-empty-payload-dropped = Inbox: đã bỏ payload trống
inbox-message-rejected = Từ chối tin nhắn inbox
inbox-unfragmented-dropped = Inbox: đã bỏ tin nhắn không phân mảnh
inbox-unknown-entity = Inbox: fragment entity không xác định; đã bỏ
...
outbox-connect-backoff = Kết nối outbox thất bại; đang áp dụng Fibonacci backoff
outbox-connect-failed-fallback = Kết nối outbox từ cache thất bại; đang dùng resolver
outbox-connect-timed-out-fallback = Kết nối outbox từ cache hết thời gian; đang dùng resolver
outbox-connect-timeout-backoff = Kết nối outbox hết thời gian; đang áp dụng Fibonacci backoff
plugin-dispatch-rejected = Từ chối plugin dispatch
...
plugin-envelope-local-reply-dropped = Plugin envelope: đã bỏ local RPC reply (không có local reply waiter)
