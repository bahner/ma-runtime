...
default-config-root-populated = /config/root durtii yeroo jalqabaatti guutame
default-config-root-no-root-entity = /config/root durtii yeroo jalqabaatti guutuu hin danda'u: entity #root hin fe'amne
default-config-root-no-root-cid = /config/root durtii yeroo jalqabaatti guutuu hin danda'u: root CID manifest hin jiru
default-config-root-inspect-failed = Manifest ilaaluun dura /config/root durtii guutuun hin milkoofne
default-config-root-populate-failed = /config/root durtii yeroo jalqabaatti guutuun hin milkoofne
...
plugin-envelope-local-reply-dropped = Plugin envelope: naannoo RPC deebii gatame (naannoo deebii eeggatu hin jiru)
...
bootstrap-kind-registry-fetch-failed = Kind node registry dhaaf fudhuun hin dandeenye
...
boot-default-root-config-skip = Default config root duraan qindaaheera
boot-entity-load-processed = Plugin entity fe'amame
boot-runtime-kinds-overlay-failed = Kinds CID overlay hojii irra oolchuu hin dandeenye
boot-runtime-manifest-load-failed = Manifest ACL cache guutuf fe'uu hin dandeenye
boot-runtime-root-cid-resolve-failed = Runtime root CID IPNS irraa furuun hin dandeenye
inbox-empty-payload-dropped = Inbox: payload duwwaa gatame
inbox-unfragmented-dropped = Inbox: ergaa qoqqooduu hin qabne gatame
inbox-unknown-entity = Inbox: entity kutaa hin beekamne; gatame
inbox-dispatching = Inbox: entity gara darbaa jira
inbox-behaviour-ignored = Inbox: ma_set_behaviour gaaffiin inbox fire-and-forget darbumsaa yeroo hin fudhatamu
...
plugin-dispatch-rejected = Plugin darbumsaa diddame
crud-message-rejected = CRUD ergaan diddame
inbox-message-rejected = Inbox ergaan diddame
outbox-connect-failed-fallback = Cached outbox walqunnamuun hin dandeenye; resolver gara deebi'ameera
outbox-connect-timed-out-fallback = Cached outbox walqunnamuu yeroo xumure; resolver gara deebi'ameera
outbox-connect-backoff = Outbox walqunnamuun hin dandeenye; Fibonacci backoff hojii irra ooleera
outbox-connect-timeout-backoff = Outbox walqunnamuu yeroo xumure; Fibonacci backoff hojii irra ooleera
