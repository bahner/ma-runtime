...
default-config-root-populated = Default /config/root fill eena startup
default-config-root-no-root-entity = Cyaa fill default /config/root eena startup: #root entity nuh load
default-config-root-no-root-cid = Cyaa fill default /config/root eena startup: manifest root CID nuh deh deh
default-config-root-inspect-failed = Fail fi check manifest before default /config/root fill
default-config-root-populate-failed = Fail fi fill default /config/root eena startup
...
boot-runtime-kinds-overlay-failed = Kyaan put on di kinds CID overlay
boot-runtime-manifest-load-failed = Kyaan load manifest fi fill up ACL cache
boot-runtime-root-cid-resolve-failed = Kyaan work out di runtime root CID from IPNS
...
bootstrap-kind-registry-fetch-failed = Kyaan get di kind node fi registry
...
inbox-behaviour-ignored = Inbox: ma_set_behaviour request dem ignore pon fire-and-forget inbox send
inbox-dispatching = Inbox: send to entity
inbox-empty-payload-dropped = Inbox: empty payload drop
inbox-message-rejected = Inbox message reject
inbox-unfragmented-dropped = Inbox: message without piece drop
inbox-unknown-entity = Inbox: unknown entity piece; drop
...
outbox-connect-backoff = Outbox connect fail; use Fibonacci backoff
outbox-connect-failed-fallback = Cache outbox connect fail; go back to resolver
outbox-connect-timed-out-fallback = Cache outbox connect run out a time; go back to resolver
outbox-connect-timeout-backoff = Outbox connect run out a time; use Fibonacci backoff
plugin-dispatch-rejected = Plugin dispatch reject
