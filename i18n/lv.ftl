...
default-config-root-populated = Noklusējuma /config/root aizpildīts startēšanas laikā
default-config-root-no-root-entity = Nevar aizpildīt noklusējuma /config/root startēšanas laikā: #root entītija nav ielādēta
default-config-root-no-root-cid = Nevar aizpildīt noklusējuma /config/root startēšanas laikā: nav pieejams manifesta saknes CID
default-config-root-inspect-failed = Neizdevās pārbaudīt manifestu pirms noklusējuma /config/root aizpildīšanas
default-config-root-populate-failed = Neizdevās aizpildīt noklusējuma /config/root startēšanas laikā
...
boot-default-root-config-skip = Noklusējuma saknes konfigurācija jau ir iestatīta
...
boot-runtime-kinds-overlay-failed = Kinds CID pārklājuma pielietošana neizdevās
boot-runtime-manifest-load-failed = Manifesta ielāde ACL kešatmiņas aizpildīšanai neizdevās
boot-runtime-root-cid-resolve-failed = Izpildvides saknes CID atrisināšana no IPNS neizdevās
...
bootstrap-kind-registry-fetch-failed = Kind mezgla iegūšana reģistram neizdevās
...
inbox-behaviour-ignored = Ienākošā pastkaste: ma_set_behaviour pieprasījumi tiek ignorēti fire-and-forget sūtīšanas laikā
inbox-dispatching = Ienākošā pastkaste: sūta entitātei
inbox-empty-payload-dropped = Ienākošā pastkaste: tukšā slodze izmesta
inbox-message-rejected = Ienākošās pastkastes ziņojums noraidīts
inbox-unfragmented-dropped = Ienākošā pastkaste: nesadrumstalots ziņojums izmests
inbox-unknown-entity = Ienākošā pastkaste: nezināms entitātes fragments; izmests
...
outbox-connect-backoff = Izejošās pastkastes savienojums neizdevās; tiek piemērots Fibonacci atpakaļsolis
outbox-connect-failed-fallback = Izejošās pastkastes savienojums no kešatmiņas neizdevās; pāreja uz atrisinātāju
outbox-connect-timed-out-fallback = Izejošās pastkastes savienojums no kešatmiņas iestājās; pāreja uz atrisinātāju
outbox-connect-timeout-backoff = Izejošās pastkastes savienojums iestājās; tiek piemērots Fibonacci atpakaļsolis
plugin-dispatch-rejected = Spraudņa nosūtīšana noraidīta
...
plugin-envelope-local-reply-dropped = Spraudņa aploksne: lokālā RPC atbilde izmesta (nav lokālā atbildes gaidītāja)
