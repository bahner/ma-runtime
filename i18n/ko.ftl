...
default-config-root-populated = 시작 시 기본 /config/root가 채워졌습니다
default-config-root-no-root-entity = 시작 시 기본 /config/root를 채울 수 없습니다: #root 엔터티가 로드되지 않았습니다
default-config-root-no-root-cid = 시작 시 기본 /config/root를 채울 수 없습니다: 매니페스트 root CID를 사용할 수 없습니다
default-config-root-inspect-failed = 기본 /config/root를 채우기 전에 매니페스트 검사에 실패했습니다
default-config-root-populate-failed = 시작 시 기본 /config/root 채우기에 실패했습니다
...
boot-default-root-config-skip = 기본 설정 루트가 이미 설정되어 있습니다
...
boot-runtime-kinds-overlay-failed = kinds CID 오버레이 적용에 실패했습니다
boot-runtime-manifest-load-failed = ACL 캐시 채우기용 매니페스트 로드에 실패했습니다
boot-runtime-root-cid-resolve-failed = IPNS에서 런타임 루트 CID 확인에 실패했습니다
...
bootstrap-kind-registry-fetch-failed = 레지스트리용 kind 노드 가져오기에 실패했습니다
...
inbox-behaviour-ignored = 받은 편지함: fire-and-forget 디스패치에서 ma_set_behaviour 요청이 무시됩니다
inbox-dispatching = 받은 편지함: 엔티티로 디스패치 중
inbox-empty-payload-dropped = 받은 편지함: 빈 페이로드가 삭제되었습니다
inbox-message-rejected = 받은 편지함 메시지가 거부되었습니다
inbox-unfragmented-dropped = 받은 편지함: 분할되지 않은 메시지가 삭제되었습니다
inbox-unknown-entity = 받은 편지함: 알 수 없는 엔티티 프래그먼트. 삭제되었습니다
...
outbox-connect-backoff = 아웃박스 연결에 실패했습니다. 피보나치 백오프를 적용합니다
outbox-connect-failed-fallback = 캐시된 아웃박스 연결에 실패했습니다. 리졸버로 폴백합니다
outbox-connect-timed-out-fallback = 캐시된 아웃박스 연결이 시간 초과되었습니다. 리졸버로 폴백합니다
outbox-connect-timeout-backoff = 아웃박스 연결이 시간 초과되었습니다. 피보나치 백오프를 적용합니다
plugin-dispatch-rejected = 플러그인 디스패치가 거부되었습니다
...
plugin-envelope-local-reply-dropped = 플러그인 엔벨로프: 로컬 RPC 응답이 삭제되었습니다 (로컬 응답 대기자 없음)
