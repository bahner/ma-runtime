...
default-config-root-populated = آغاز پر پہلے سے طے شدہ /config/root بھر دیا گیا
default-config-root-no-root-entity = آغاز پر پہلے سے طے شدہ /config/root نہیں بھرا جا سکتا: #root entity لوڈ نہیں ہوئی
default-config-root-no-root-cid = آغاز پر پہلے سے طے شدہ /config/root نہیں بھرا جا سکتا: manifest root CID دستیاب نہیں
default-config-root-inspect-failed = پہلے سے طے شدہ /config/root بھرنے سے پہلے manifest کا معائنہ ناکام رہا
default-config-root-populate-failed = آغاز پر پہلے سے طے شدہ /config/root بھرنے میں ناکامی
...
owners-value-not-list = owners کی قدر DIDs کی فہرست ہونی چاہیے، ایک واحد قدر نہیں
...
boot-default-root-config-skip = ڈیفالٹ روٹ کنفیگریشن پہلے سے سیٹ ہے
...
boot-runtime-kinds-overlay-failed = Kinds CID اوورلے لاگو کرنا ناکام رہا
boot-runtime-manifest-load-failed = ACL کیش بھرنے کے لیے مینیفیسٹ لوڈ کرنا ناکام رہا
boot-runtime-root-cid-resolve-failed = IPNS سے رن ٹائم روٹ CID حل کرنا ناکام رہا
...
bootstrap-kind-registry-fetch-failed = رجسٹری کے لیے Kind نوڈ لانا ناکام رہا
...
inbox-behaviour-ignored = ان باکس: fire-and-forget بھیجنے پر ma_set_behaviour درخواستیں نظر انداز کی جاتی ہیں
inbox-dispatching = ان باکس: انٹیٹی کو بھیجا جا رہا ہے
inbox-empty-payload-dropped = ان باکس: خالی پے لوڈ حذف کر دیا گیا
inbox-message-rejected = ان باکس پیغام مسترد ہو گیا
inbox-unfragmented-dropped = ان باکس: غیر مجزوء پیغام حذف کر دیا گیا
inbox-unknown-entity = ان باکس: نامعلوم انٹیٹی ٹکڑا؛ حذف کر دیا گیا
...
outbox-connect-backoff = آؤٹ باکس کنکشن ناکام رہا؛ Fibonacci بیک آف لاگو ہو رہا ہے
outbox-connect-failed-fallback = کیش سے آؤٹ باکس کنکشن ناکام رہا؛ ریزولور پر واپس جا رہے ہیں
outbox-connect-timed-out-fallback = کیش سے آؤٹ باکس کنکشن کا وقت ختم ہو گیا؛ ریزولور پر واپس جا رہے ہیں
outbox-connect-timeout-backoff = آؤٹ باکس کنکشن کا وقت ختم ہو گیا؛ Fibonacci بیک آف لاگو ہو رہا ہے
plugin-dispatch-rejected = پلگ ان ڈسپیچ مسترد ہو گیا
...
plugin-envelope-local-reply-dropped = پلگ ان لفافہ: مقامی RPC جواب حذف کر دیا گیا (کوئی مقامی جواب انتظار کنندہ نہیں)
